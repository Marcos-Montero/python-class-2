...
class Pokemon:
    def __init__(self, name, type, hp, attack_power):#añado a attack el _power para que no se confunda con el método attack
        self.name = name
        self.type = type
        self.hp = hp
...
pikachu.attack(charizard) #esto lo hago para que charizard llegue a 0 hp y se vea el mensaje de faint()